...
class Post extends Component {
  ...
  render(){
    ...
    const showURL = url ? <a style={styles.link} href={`${urlFix}`} target='_blank' title={url}>{url}</a> : null
        ...
        <CardActions>
          <div>
            ...
            >
              ...
              >
                <ActionThumbDown
                  color={isLikedOrDisliked ? grey500 : pinkA200}
                />
              </IconButton>
            </Badge>
            <Badge
            ...
            >
              <IconButton
                tooltip='Like'
                disabled={isLikedOrDisliked}
                onTouchTap={this.onLikeTap}>
                  <ActionThumbUp
                    color={isLikedOrDisliked ? grey500 : cyan500}
                  />
              </IconButton>
            </Badge>
          </div>
